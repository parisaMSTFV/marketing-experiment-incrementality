...
|---|---|---|
| Orders per customer | Total completed experiment-period orders divided by randomized customers | Primary outcome |
| Purchase conversion | Share of randomized customers with at least one experiment-period order | Secondary outcome |
| Revenue per customer | Experiment-period order revenue divided by randomized customers | Secondary outcome |
| Contribution per customer | Revenue after simulated variable commerce costs, before campaign cost | Secondary outcome |
| Absolute effect | Treatment mean minus control mean | Causal estimate |
| Relative lift | Absolute effect divided by the control mean | Communication metric |
...
| Break-even incentive cost | Incentive cost per treated order that makes net incremental profit zero at a stated contribution-margin multiplier | Stress-test metric |
| SRM p-value | Chi-square test of observed versus planned treatment allocation | Experiment health |
| Standardized mean difference | Treatment-control pre-period mean difference divided by pooled standard deviation | Balance diagnostic |
